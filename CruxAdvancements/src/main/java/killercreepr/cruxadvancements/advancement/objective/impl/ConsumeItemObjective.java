...
public class ConsumeItemObjective extends NumberObjective {
    public ConsumeItemObjective(@NotNull ObjectiveCommonData data, int maxProgress) {
    ...
    public boolean trigger(@NotNull UUID who,
                        ...
                        @NotNull PlayerItemConsumeEvent event){
