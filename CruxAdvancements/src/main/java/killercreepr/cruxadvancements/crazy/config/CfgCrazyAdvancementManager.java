package killercreepr.cruxadvancements.crazy.config;
...
import killercreepr.cruxadvancements.core.config.loader.CrazyAdvancementCfgLoader;
...
import killercreepr.cruxadvancements.crazy.advancement.CrazyAdvancementManager;
...
public class CfgCrazyAdvancementManager extends CrazyAdvancementManager<CrazyAdvancement> {
    ...
    @Override
    public void saveAllUserProgress(@NotNull CrazyAdvancement... advancements) {
        if(advancements.length == 0) advancements = this.advancements.values().toArray(new CrazyAdvancement[0]);
