...
public class SimpleCruxAttributeModifier implements CruxAttributeModifier {
     ...
     * Creates a base attribute modifier.
     */
    public SimpleCruxAttributeModifier(double amount, @Nullable CruxSlot slot) {
     ...
     * Creates a base attribute modifier.
     */
    public SimpleCruxAttributeModifier(double amount, @NotNull CruxAttribute.Operation operation, @Nullable CruxSlot slot) {
