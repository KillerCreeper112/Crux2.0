...
import killercreepr.cruxblocks.core.block.data.listeners.BlockDataListener;
import org.bukkit.*;
...
public class CustomBlockData implements PersistentDataContainer {
     ...
     */
    public static void registerListener(@NotNull Plugin plugin) {
    ...
    public <T, Z> void set(final @NotNull String namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType, final @NotNull Z z) {
        set(Crux.key(namespacedKey), persistentDataType, z);
    }
    ...
    public <T, Z> boolean has(final @NotNull String namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType) {
        return has(Crux.key(namespacedKey), persistentDataType);
    }
    ...
    public boolean has(final @NotNull String namespacedKey){
        return has(Crux.key(namespacedKey));
    }
    @Override
    ...
    public <T, Z> Z get(final @NotNull String namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType){
        return get(Crux.key(namespacedKey), persistentDataType);
    }

    public <T, Z> Z get(final @NotNull String namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType, @Nullable Z z){
        return get(Crux.key(namespacedKey), persistentDataType, z);
    }

    public <T, Z> Z get(final @NotNull NamespacedKey namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType, @Nullable Z z){
        try{
            Z x = pdc.get(namespacedKey, persistentDataType);
            if(x == null) return z;
            return x;
        }catch (Exception x){ return z; }
    }
    ...
    public <T, Z> Z getOrDefault(final @NotNull String namespacedKey, final @NotNull PersistentDataType<T, Z> persistentDataType, final @NotNull Z z){
        return getOrDefault(Crux.key(namespacedKey), persistentDataType, z);
    }
    ...
    public void remove(final @NotNull String namespacedKey) {
        remove(Crux.key(namespacedKey));
    }
