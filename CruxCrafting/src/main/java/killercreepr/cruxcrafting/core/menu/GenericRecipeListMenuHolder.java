...
public class GenericRecipeListMenuHolder extends SimpleMenuHolder {
    public GenericRecipeListMenuHolder(@NotNull Key key, @Nullable String title,
    ...
    public @NotNull CfgMenu createMenu(@NotNull DataExchange data, @Nullable MergedTagContainer tags) {
        return new GenericRecipeListMenu(this, data, tags);
    }
}
