...
public class GenericRecipeViewMenuHolder extends SimpleMenuHolder {
    public GenericRecipeViewMenuHolder(@NotNull Key key, @Nullable String title,
    ...
    public @NotNull CfgMenu createMenu(@NotNull DataExchange data, @Nullable MergedTagContainer tags) {
        return new GenericRecipeViewMenu(this, data, tags);
    }
}
