...
public class VariableDynamicDistanceGoalNode extends VariableGoalNode {
    ...
    public VariableDynamicDistanceGoalNode(Consumer<PathTargetMobGoal> onTick, Consumer<PathTargetMobGoal> onStart, Consumer<PathTargetMobGoal> onFinish, DataExchange info, Holder<Location> location, double distance) {
