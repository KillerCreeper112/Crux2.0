...
import killercreepr.crux.core.data.SimpleDataExchange;
...
public interface DataExchange extends Iterable<Holder<?>> {
    ...
    default <T> T getWithDefault(@NotNull Class<T> find, @Nullable Function<DataExchange, T> defaultValue){
        T value = get(find);
        if(value != null) return value;
        return defaultValue == null ? null : defaultValue.apply(this);
    }

    default Object getWithDefault(@NotNull String id, @Nullable Function<DataExchange, Object> defaultValue){
        Object value = get(id);
        if(value != null) return value;
        return defaultValue == null ? null : defaultValue.apply(this);
    }

    default <T> T getWithDefault(@NotNull String id, @NotNull Class<T> type, @Nullable Function<DataExchange, T> defaultValue){
        T value = get(id, type);
        if(value != null) return value;
        return defaultValue == null ? null : defaultValue.apply(this);
    }
