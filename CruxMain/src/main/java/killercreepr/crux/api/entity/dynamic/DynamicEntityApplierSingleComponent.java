...
import killercreepr.crux.core.item.dynamic.component.SimpleDynamicItemComponent;
...
public abstract class DynamicEntityApplierSingleComponent implements DynamicEntityApplierComponent {
    protected final @NotNull Object value;
    public DynamicEntityApplierSingleComponent(@NotNull Object value) {
        this.value = value;
    }
