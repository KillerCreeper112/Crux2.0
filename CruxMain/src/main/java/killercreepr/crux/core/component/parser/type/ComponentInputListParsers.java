...
public class ComponentInputListParsers {
    ...
    public final PersistTextParser<List<ItemLootTable>> ITEM_LOOT_TABLE = PersistTextParser.list(ComponentInputParsers.ITEM_LOOT_TABLE, CruxPersistence.LIST.ITEM_LOOT_TABLE);
