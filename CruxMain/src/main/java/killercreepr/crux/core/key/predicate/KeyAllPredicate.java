...
public class KeyAllPredicate implements KeyPredicate, StringListEncodeComponent {
    protected final @NotNull Collection<KeyPredicate> children;
    public KeyAllPredicate(@NotNull Collection<KeyPredicate> children) {
    ...
    public @NotNull Collection<KeyPredicate> getChildren() {
        return children;
    }
