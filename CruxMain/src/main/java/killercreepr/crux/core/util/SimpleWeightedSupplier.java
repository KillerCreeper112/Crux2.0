...
public class SimpleWeightedSupplier<T extends WeightedObject> implements CruxWeightedSupplier<T> {
    ...
    public SimpleWeightedSupplier(@NotNull Collection<T> poll, int rolls, float luck, @Nullable Consumer<T> onAccepted, @Nullable Predicate<T> filter) {
        this.poll = poll;
        this.rolls = rolls;
        this.luck = luck;
    ...
    public static final class Builder<T extends WeightedObject> implements CruxWeightedSupplierBuilder<T> {
