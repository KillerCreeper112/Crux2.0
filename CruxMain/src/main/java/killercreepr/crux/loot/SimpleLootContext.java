...
public class SimpleLootContext implements LootContext {
    ...
    public SimpleLootContext(Location location, Entity looter, Entity looted, Random random, DataExchange info){
        this(location,
    ...
    public SimpleLootContext(Location location, float luck, Entity looter, Entity looted, Random random, DataExchange info) {
