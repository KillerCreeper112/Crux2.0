...
public class GrimAnyOfCondition implements LootCondition {
    private final Collection<LootCondition> conditions;

    public GrimAnyOfCondition(@NotNull Collection<LootCondition> conditions) {
    ...
    /*public static @Nullable GrimAnyOfCondition deserialize(@NotNull JsonElement e){
        ...
        return new GrimAnyOfCondition(conditions);
    }
