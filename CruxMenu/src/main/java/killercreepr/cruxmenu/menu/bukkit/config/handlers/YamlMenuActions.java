...
public class YamlMenuActions extends YamlModuled<ClickActions> {

    public YamlMenuActions(@NotNull YamlMenuModule menuModule) {
        super(menuModule);
    }

    public @Nullable ClickActions deserializeFromYaml(@NotNull YamlContext context, @Nullable YamlElement e,
