 ...
 */
public class MenuItemClickEvent extends MenuEntityCancellableEvent {
    ...
    public MenuItemClickEvent(@NotNull Entity who, @NotNull Menu menu, @NotNull MenuItem item, @NotNull ActionContext context, @Nullable ClickActions clickActions) {
        super(who, menu);
        this.item = item;
