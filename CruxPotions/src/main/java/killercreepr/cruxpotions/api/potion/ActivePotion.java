...
public interface ActivePotion{
    ...
    static @NotNull String formatPotion(@NotNull String name, int amplifier, int duration){
        ...
        builder.append("(").append(formatDuration(duration)).append(")");
    ...
    default @NotNull StoredPotion store(){
        return StoredPotion.storedPotion(getPotion(), getDuration(), getAmplifier());
    }

    default @Nullable FileObject deserializeDataToFile(){
        return null;
    }
}
