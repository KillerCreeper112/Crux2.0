...
public class StructureComponents {
    ...
    public static final DataComponentType<StructureEditorComponent> TICKED_STORED = register("ticked_stored", builder -> builder);
    public static final DataComponentType<StructureBlockPlaceInsideComponent> BLOCK_PLACE_INSIDE = register("block_place_inside", builder -> builder);
